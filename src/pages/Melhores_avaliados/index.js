...
function MelhoresAvaliados(){
    ...
    useEffect(() => {
        async function loadFilmes(){
            const response = await res.get("/movie/top_rated", {
                params:{
            ...
            {filmes.map((filme) => {
                    return(
                        <article className='lista-filmes-em-cartaz-filme'>
                            ...
                            <img className='lista-filmes-em-cartaz-filme-img' alt='Poster do filme' src={`https://image.tmdb.org/t/p/original/${filme.poster_path}`}/>
